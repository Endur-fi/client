...
const Stats: React.FC = () => {
  ...
  React.useEffect(() => {
    (async () => {
      ...
      setStakedUSD(Number(currentStaked.value.toString()) * price);
    })();
  }, [currentStaked]);

  return (
    <div className="font-poppins flex h-fit w-full items-center justify-between gap-3 rounded-xl border border-[#AACBC4]/30 bg-white p-5 px-12 shadow-sm">
