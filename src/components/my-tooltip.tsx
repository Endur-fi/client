...
const MyDottedTooltip = ({
  ...
  return (
    ...
    >
      ...
      {showTooltip && (
        <div className="absolute bottom-full left-1/2 z-10 mb-2 w-[300px] max-w-[300px] -translate-x-1/2 transform rounded-lg border-[1px] border-gray-200 bg-white px-3 py-2 text-xs text-black shadow-lg">
          {tooltip}
