  ...
  const faq: FAQItem[] = [
    {
      ...
      answer: (
        <>
          ...
          click the Stake button. {"You'll"} receive liquid staking tokens
          (xSTRK or xyBTC) that represent your staked position.
        </>
      ),
    },
    {
      ...
      answer: (
        <>
          ...
          Unstake button. Select {'"Use DEX"'} or {'"Use Endur"'} to choose your
          preferred withdrawal method. DEX is instantaneous but price is usually
          less than {"Endur's"}. With Endur, Your tokens will be queued for
          withdrawal and may take upto 7-8 days.
        </>
      ),
    },
    {
      ...
      answer: (
        <>
          When you native stake on Starknet, your tokens are locked and to
          withdraw, you may need to wait for 7 days. Liquid staking allows you
          to stake your tokens while maintaining liquidity. If you need
          liquidity immediately, with liquid staking, you have the optionality
          to redeem them instantly via DEX. Additionally, the LSTs can be used
          in DeFi protocols for additional yield or as collateral for borrowing.
        </>
      ),
    },
    {
      ...
      answer: (
        <>
          ...
          Starknet network. Endur delegates your staked tokens to validators on
          your behalf.
        </>
      ),
    },
    {
      ...
      answer: (
        <>
          Audit reports are available in our documentation{" "}
          <Link
          ...
          Additionally, Endur is governed by a 3/4 multisig controlled by the
          Unwrap Labs and Karnot team. Further, Endur is looking to perform more
          security audits, reduce permissioned functions and add real time risk
          monitoring (e.g. Hypernative) by Q1 2026.
        </>
        // <>
