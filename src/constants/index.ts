...
// AVNU exchange contract used for swap-based unstake routes (multi_route_swap).
export const AVNU_EXCHANGE_ADDRESS =
  "0x04270219d365d6b017231b52e92b3fb5d7c8378b05e9abc97724537a80e93b0f";

// Privy-managed Starknet account class hash. Used to validate the account
// class hash of paymaster `deploy` transactions sponsored by /api/paymaster.
// Mainnet only for now; extend per-network if/when sepolia is supported.
export const PRIVY_ACCOUNT_CLASS_HASH_SN_MAIN =
